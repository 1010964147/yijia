var register = (function(){
    ...
    return {
        init: function(ele) {
            ...
            // 获取提交按钮
            this.$loginBtn = this.$ele['login_on'];
        ...
        event: function() {
            ...
            this.$loginBtn.onclick = function() {
                ...
                sendAjax('http://localhost:2333/1808/shop/yijiashouji/php/register.php', params);
            },
            // 判断用户名称是否存在
            this.$usernameInp. addEventListener('change', function(){
                ...
                sendAjax('http://localhost:2333/1808/shop/yijiashouji/php/check_username.php', params);
            }, false);
        },
